/* ===================================================================
   GSAP — scroll storytelling. No Three.js in this build: Coinbase's
   signature hero pattern is a layered product-UI mockup card stack on
   a dark editorial canvas, not a spatial/network visual, so the hero
   here is pure HTML/CSS (see .hero-mockups) driven by GSAP parallax.
=================================================================== */
function initGsap() {
  ...
  heroTl
    ...
    .to('.hero-sub.reveal-up, .hero-actions.reveal-up', { opacity: 1, y: 0, duration: 0.9, ease: 'power3.out', stagger: 0.12 }, 0.55)
    .to('.hero-mockups.reveal-up', { opacity: 1, y: 0, duration: 1, ease: 'power3.out' }, 0.5);

  gsap.to('.pui-card--back', {
    y: -18,
    scrollTrigger: { trigger: '.hero', start: 'top top', end: 'bottom top', scrub: true },
  });
  gsap.to('.pui-card--front', {
    y: 18,
    scrollTrigger: { trigger: '.hero', start: 'top top', end: 'bottom top', scrub: true },
  });
  ...
  gsap.to('.mini-chart span, .pui-bars span', {
