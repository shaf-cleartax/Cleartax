/* ===================================================================
   GSAP — scroll storytelling. No Three.js / particle hero in this
   build: the brand's signature is the gradient mesh + composited
   dashboard mockup, both pure HTML/CSS, animated in with GSAP.
=================================================================== */
function initGsap() {
  ...
  heroTl
    ...
    .to('.dash-mockup.reveal-up', { opacity: 1, y: 0, duration: 1, ease: 'power3.out' }, 0.5);
  ...
  gsap.to('.mini-chart span, .dash-bars span', {
